...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="py-24 relative overflow-hidden bg-background" // Removed px-4 for full-width slider
    >
      {/* Subtle animated gradient background */}
      <div className="absolute inset-0 bg-gradient-to-b from-background/20 via-primary/10 to-background/30 -z-10 blur-3xl" />
      ...
      <div className="w-full overflow-hidden">
        ...
        >
          ...
          {duplicatedProjects.map((project, index) => (
            <motion.div
              key={index}
              // Removed the whileInView animation as it conflicts with the marquee
